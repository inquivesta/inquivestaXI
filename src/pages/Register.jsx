...
const Register = () => {
  ...
  var eventForms = {
    ...
    Anicon: {formTitle: "Anicon 3.0", form: [...defaultForm, "institute", 
      ...
      {name: "amt1", renderOn: "1", ele: information("Amount Payable: INR 33 (INR 0 for IISER-K students. Write N/A for UTR)")},
      {name: "amt2", renderOn: "2", ele: information("Amount Payable: INR 49 (INR 33 for IISER-K Students)")},
      {name: "amt3", renderOn: "3", ele: information("Amount Payable: INR 69 (INR 49 for IISER-K Students")},
      {name: "qr", ele: <Qrcode images={["/payments/qr-1.jpeg", "/payments/qr-2.jpeg", "/payments/qr-3.jpeg"]}/>},
      {name: "utr", ele: textarea("Enter full UTR number", "utr", "UTR goes here")},
    ]},
